    ...
    <div className="text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-24 overflow-hidden">
        ...
        <div className="absolute inset-0 parallax-bg">
          <div className="absolute top-0 -right-24 w-96 h-96 bg-gradient-to-br from-purple-500/30 to-pink-500/30 rounded-full filter blur-3xl animate-liquid-blob" style={{ transform: 'translateZ(-100px)' }} />
          <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-gradient-to-br from-blue-500/30 to-cyan-500/30 rounded-full filter blur-3xl animate-liquid-blob animation-delay-4000" style={{ transform: 'translateZ(-150px)' }} />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-full filter blur-3xl" style={{ transform: 'translateZ(-200px)' }} />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl font-bold mb-6 leading-tight shimmer-text"
            >
            ...
            >
              ...
              <Link
                to="/about"
                className="inline-flex items-center space-x-2 px-8 py-4 rounded-full text-lg font-medium text-gray-100 border border-gray-600 hover:border-gray-400 hover:text-white transition-all duration-300"
              >
          ...
          >
            ...
            <div>
              ...
              <motion.div
                ...
                className="space-y-4 text-gray-100 text-lg leading-relaxed"
              >
                <p>
          ...
          >
            {features.map((feature) => (
              ...
              >
                ...
                <div className={`relative z-10 interactive-card-icon bg-gradient-to-br ${feature.gradient}`}>
                  <feature.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="relative z-10 interactive-card-title">
                  {feature.title}
                </h3>
                <p className="relative z-10 interactive-card-description">
                  {feature.description}
                </p>
              </motion.div>
            ))}
        ...
        >
          ...
          <div className="relative p-8 md:p-12 bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-3xl shadow-2xl">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-100 text-lg">Thousands of women are transforming their lives with Newomen</p>
            </div>

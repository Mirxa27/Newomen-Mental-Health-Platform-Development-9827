...
const { FiHome, FiUsers, FiMessageSquare, FiEdit, FiBarChart3, FiCpu, FiSettings, FiX } = FiIcons;
                  ...
                  return (
                    <Link
                      ...
                      className={`
                        ...
                        ${isActive ? 'bg-primary-50 text-primary-600 border-r-2 border-primary-500' : 'text-gray-700 hover:bg-gray-50 hover:text-primary-600'}
                      `}
                      aria-current={isActive ? 'page' : undefined}
                    >
                      <SafeIcon

    ...
    <div className="space-y-8">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <motion.div
          ...
          className="glass-card rounded-glass"
        >
        ...
        >
          ...
          <div className="mt-4 space-y-2">
            {subscriptionData.map((item) => (
              <div key={item.name} className="flex items-center justify-between p-2 rounded-lg hover:bg-glass-medium transition-all duration-300">
                <div className="flex items-center space-x-3">
                  <div 
        ...
        <div className="space-y-4">
          {[
            ...
            <motion.div
              ...
              className="flex items-start space-x-3 p-3 rounded-xl hover:bg-glass-medium transition-all duration-300"
            >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <button className="glass-button-primary flex items-center justify-center space-x-2">

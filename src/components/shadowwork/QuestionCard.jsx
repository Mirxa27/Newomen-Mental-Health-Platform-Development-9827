...
const QuestionCard = ({ question, questionNumber, totalQuestions }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white/80 backdrop-blur-sm rounded-xl md:rounded-3xl p-6 md:p-8 shadow-xl border border-white/20"
    >
      <div className="mb-6">
      ...
      <div className="space-y-3 md:space-y-4">
        <textarea
          ...
          className="w-full h-28 md:h-32 px-4 py-3 border border-gray-300 rounded-xl md:rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none transition-all"
